...
/**
 * Servlet implementation class danhMucSanPhamController
 */
@WebServlet("/danhMucSanPhamController")
public class DanhMucSanPhamController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<SanPham> arr = SanPhamDao.danMucSanPham(id);
